...
export const metadata: Metadata = {
  ...
  description:
    "Explore BizAI Hacks' range of AI-powered web development, app design, and automation services to enhance your business.",
  openGraph: {
    title: "BizAI Hacks Services",
    description:
      "We offer digital transformation services including AI automation, web development, and business growth solutions.",
  ...
  twitter: {
    ...
    title: "BizAI Hacks - Services",
    description:
      "Boost your digital presence with our expert AI-powered development services.",
