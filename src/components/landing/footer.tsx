...
// }
  ...
  return (
    ...
    >
      ...
      />
      <Button type="submit" className="w-full btn-primary-custom hover:bg-primary/90 mt-3" disabled={loading}>
        Subscribe
      </Button>
    </form>
            <p
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          ...
          >
            ...
            <Link href="https://soltechtechservices.com"><strong>SOLTECH TechServices Pvt Ltd</strong>.</Link>
          </p>
